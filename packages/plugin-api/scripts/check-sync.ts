 ...
 * mirrors the host barrel at `apps/desktop/src/features/plugins/lib/pluginApi.ts`.
 *
...
const HOST_BARREL = resolve(REPO_ROOT, "apps/desktop/src/features/plugins/lib/pluginApi.ts");
