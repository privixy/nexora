...
- Rust commands under `apps/desktop/src-tauri/src/commands/` are transport adapters; domains own Tauri-independent workflows and explicit context, drivers own database semantics, and infrastructure owns engine-neutral mechanisms.
