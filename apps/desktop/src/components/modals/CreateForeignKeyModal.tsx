...
export const CreateForeignKeyModal = ({
  ...
  }, [isOpen, connectionId, tableName, database, resolvedSchema]);
  ...
  }, [refTable, isOpen, connectionId, database, resolvedSchema]);
  ...
  }, [fkName, localColumn, refTable, refColumn, onDelete, onUpdate, connectionId, tableName, resolvedSchema, t]);
