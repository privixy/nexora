...
import { SshConnectionsModal } from "../../../../shared/ui/SshConnectionsModal";
import { K8sConnectionsModal } from "../../../../shared/ui/K8sConnectionsModal";
...
import { fetchConnectionWithCredentials } from "../../lib/credentials";
import { getDriverIcon, getDriverColorStyle } from "../../lib/driverUI";
import {
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-xs text-muted">
            {t("newConnection.pipesAsConcatHint", {
              defaultValue:
                "Leave enabled — Nexora automatically skips it on servers that reject it (Vitess/PlanetScale).",
            })}
          </p>
        </div>
      )}
