...
import { isGeometricType } from "../../../data-grid";
import { GeometryInput } from "../../../data-grid";
import type { ForeignKey } from "../../../schema";
import { SlotAnchor } from "../../../plugins";
...
export const NewRowModal = ({
  ...
  const fetchFkOptions = useCallback(async (fk: ForeignKey) => {
    ...
    try {
      const quotedTable = quoteTableRef(fk.ref_table, activeDriver, effectiveSchema);
  ...
  }, [activeConnectionId, activeDriver, database, effectiveSchema]);
  ...
  }, [isOpen, activeConnectionId, tableName, fetchFkOptions, t, database, effectiveSchema]);
