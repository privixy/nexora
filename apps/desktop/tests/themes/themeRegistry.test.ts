...
import { themeRegistry } from '../../src/features/settings/themes/themeRegistry';

describe('themeRegistry', () => {
  describe('getPreset', () => {
    it('should return nexora-dark theme', () => {
      const theme = themeRegistry.getPreset('nexora-dark');
      expect(theme).toBeDefined();
      expect(theme?.id).toBe('nexora-dark');
      expect(theme?.name).toBe('Nexora Dark');
      expect(theme?.isPreset).toBe(true);
    });

    it('should return nexora-light theme', () => {
      const theme = themeRegistry.getPreset('nexora-light');
      expect(theme).toBeDefined();
      expect(theme?.id).toBe('nexora-light');
      expect(theme?.name).toBe('Nexora Light');
    });
  ...
  describe('getAllPresets', () => {
    ...
    it('should include nexora-dark as first theme', () => {
      const themes = themeRegistry.getAllPresets();
      const darkTheme = themes.find(t => t.id === 'nexora-dark');
      expect(darkTheme).toBeDefined();
    });
  });

  describe('getDefault', () => {
    it('should return nexora-dark as default', () => {
      const defaultTheme = themeRegistry.getDefault();
      expect(defaultTheme.id).toBe('nexora-dark');
      expect(defaultTheme.name).toBe('Nexora Dark');
    });
  ...
  describe('isDarkTheme', () => {
    it('should return true for vs-dark base', () => {
      const darkTheme = themeRegistry.getPreset('nexora-dark');
    ...
    it('should return false for vs base (light themes)', () => {
      const lightTheme = themeRegistry.getPreset('nexora-light');
