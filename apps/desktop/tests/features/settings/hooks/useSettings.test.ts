...
import { SettingsContext, DEFAULT_SETTINGS, type Settings } from '../../../../src/features/settings/state/SettingsContext';
import { renderHook } from '@testing-library/react';
import React, { type ReactNode } from 'react';
import type { SettingsContextType } from '../../../../src/features/settings/state/SettingsContext';
