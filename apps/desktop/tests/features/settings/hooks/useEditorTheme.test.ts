...
import { useEditorTheme } from '../../../../src/features/settings/hooks/useEditorTheme';
import { ThemeContext, type ThemeContextType } from '../../../../src/features/settings/state/ThemeContext';
import {
  SettingsContext,
  DEFAULT_SETTINGS,
...
const themeSettings: ThemeSettings = {
  ...
  lightThemeId: 'nexora-light',
  darkThemeId: 'nexora-dark',
  customThemes: [],
};
