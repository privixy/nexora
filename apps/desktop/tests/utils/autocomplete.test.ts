...
} from '../../../src/shared/lib/autocomplete';
...
// Mock sqlAnalysis
vi.mock('../../../src/shared/lib/sqlAnalysis', () => ({
...
describe('autocomplete', () => {
  ...
  describe('registerSqlAutocomplete', () => {
    ...
    it('passes database context when fetching columns', async () => {
      const mockInvoke = invoke as unknown as ReturnType<typeof vi.fn>;
      mockInvoke.mockResolvedValueOnce([{ name: 'id', data_type: 'INTEGER' }]);
      const monaco = createMockMonaco();
  ...
  describe('caching behavior', () => {
    it('should cache column data with TTL', async () => {
      ...
      const { parseTablesFromQuery } = await import('../../../src/shared/lib/sqlAnalysis');
