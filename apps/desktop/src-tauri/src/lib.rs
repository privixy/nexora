...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            // when Nexora is closed and fail fast on approval-gated
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            connection_import_commands::preview_nexora_import,
            connection_import_commands::apply_nexora_import,
            ...
            task_manager::get_nexora_children,
