...
Use this checklist when authoring `manifest.json` for a Nexora database plugin.
...
- `schemas`: true only if the database exposes multiple named schemas/namespaces in Nexora terms
